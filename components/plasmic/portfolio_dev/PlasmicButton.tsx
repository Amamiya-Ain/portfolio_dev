...
import sty from "./PlasmicButton.module.css"; // plasmic-import: JsnXeyw-TQlm/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: Fnc9ejXOKEek/icon
import ChevronDown2Icon from "./icons/PlasmicIcon__ChevronDown2"; // plasmic-import: Zdkxj1CXZs21/icon
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__tV57, {
          [sty.freeBoxcolor_neutral__tV57Ldmel]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__tV57M98WnYxXFn]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxcolor_white__tV57PFu4J]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__tV57M6Yd]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__tV573AL]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__tV57YMYq]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__tV57L3UiO]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__tV57EftcE]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__tV57YxXFn]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___4KGns, {
            [sty.freeBoxcolor_neutral___4KGnsLdmel]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft___4KGnsLdmelMtnwK]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart___4KGnsSgxEo]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge___4KGns3AL]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___4KGnsl3UiO]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___4KGnseftcE]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered___4KGnsYxXFn]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg___66GqZ)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__nJpYp, {
            [sty.freeBoxiconEnd__nJpYplpadj]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__nJpYp3AL]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__nJpYPl3UiO]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__nJpYPeftcE]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg__xyqZc)}
                role={"img"}
              />
            ),
